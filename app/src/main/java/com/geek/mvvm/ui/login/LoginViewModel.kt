...
import com.geek.mvvm.data.Result
...
class LoginViewModel @Inject constructor(private val loginRepository: LoginRepository) : ViewModel(),LoginDataSource.DataSourceCallback {
    ...
    override fun dataSourceResponse(result: Result<LoginResponse>) {
        if (result is Result.Loading) {
            _loginResult.value = LoginResult(loading = result.message)
